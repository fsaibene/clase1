	...
	<div class="container">
		...
		<div class="CajaInicio animated bounceInRight">
			...
			<form id="FormIngreso" method="post" action="formAlta.php" enctype="multipart/form-data" >
				...
				<input type="text" name="legajo" id="legajo" placeholder="ingrese legajo" value="<?php echo isset($unaPersona) ?  $unaPersona->GetLegajo() : "" ; ?>" <?php echo isset($unaPersona) ?  "readonly": "" ; ?>        /> <span id="lblLeg" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
